# Generated by Django 4.0.4 on 2022-07-20 19:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Backup',
            fields=[
                ('num_dist', models.CharField(max_length=20, primary_key=True, serialize=False, verbose_name='número de empresario')),
                ('nombres', models.CharField(max_length=200)),
                ('descuento_choice', models.CharField(max_length=10)),
                ('tel_casa', models.CharField(max_length=10, verbose_name='teléfono')),
                ...
                ('campania', models.CharField(max_length=200, verbose_name='campaña')),
                ('cedi', models.CharField(max_length=200)),
                ('registro_no_exi', models.CharField(blank=True, max_length=200, null=True, verbose_name='no exitoso')),
                ('registro_exi', models.CharField(blank=True, max_length=200, null=True, verbose_name='exitoso')),
                ('comentario', models.TextField(blank=True, null=True)),
                ('remarcar', models.BooleanField()),
                ('fecha_interaccion', models.DateTimeField(auto_now=True, verbose_name='última interacción')),
            ],
            options={
                'verbose_name': 'Backup',
        ...
        migrations.CreateModel(
            name='Campania',
            fields=[
                ('nombre', models.CharField(max_length=200, primary_key=True, serialize=False, verbose_name='campaña')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('num_dist', models.CharField(max_length=20, verbose_name='Número de empresario')),
                ('nombre', models.CharField(max_length=200)),
                ('descuento_choice', models.CharField(choices=[('20', '20'), ('25', '25'), ('30', '30'), ('35', '35'), ('40', '40')], default='20', max_length=10)),
                ('fecha_creacion', models.DateTimeField(auto_now_add=True)),
                ('tel_casa', models.CharField(max_length=10, verbose_name='teléfono')),
                ('tel_cel', models.CharField(max_length=10, verbose_name='ceclular')),
                ('pais', models.CharField(max_length=100)),
                ('estado', models.CharField(max_length=100)),
                ('centro_alta', models.CharField(max_length=100)),
                ('email', models.EmailField(max_length=254)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contacto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='campanias.contacto', verbose_name='número de empresario')),
